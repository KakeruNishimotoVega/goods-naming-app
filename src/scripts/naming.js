...
function renderMinimalCategoryForm() {
    ...
    html += '<input type="text" id="minimal-catchcopy" class="form-control" placeholder="キャッチコピーを入力してください" />';
    html += '</div>';
    
    html += '<div class="input-group">';
    html += '<label for="minimal-productname">商品名</label>';
    html += '<input type="text" id="minimal-productname" class="form-control" placeholder="商品名を入力してください" />';
    html += '</div>';
